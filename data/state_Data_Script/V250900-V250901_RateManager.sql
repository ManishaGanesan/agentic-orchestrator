...
/* This Script is used for HTML5 UPGRADE from V250900 to V250901.
Run this script on [RateManager] V250900 to upgrade it to [RateManager] V250901.
...
SET @FromDVersion = '2509.00'; -- the DVersion in the database
...
BEGIN TRANSACTION
  BEGIN TRY
    ...
    INSERT INTO [dbo].[ADM_SystemVersion] ([AVersion], [DVersion], [PVersion], [InsertedTS])
      VALUES (N'2509.01', N'2509.01', NULL, GETDATE())
