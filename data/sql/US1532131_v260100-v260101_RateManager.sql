...
UPDATE [dbo].[LUT_PricerTypeVariable] SET [VariableDescr]=N'OPPS percentage multiplier that is used to adjust reimbursement for all services excluding certain laboratory services.', [ModifiedTS]='20260122 00:00:00.000', [DisplayStartDate]='20260101' WHERE [LUTPTVID]=4112
...
UPDATE [dbo].[LUT_PricerTypeVariable] SET [DefaultValue]=N'39,360.00', [ModifiedTS]='20260122 00:00:00.000' WHERE [LUTPTVID]=1433
...
-- Medicare FQHC
UPDATE [dbo].[LUT_PricerTypeVariable] SET [DefaultValue]=N'207.72', [ModifiedTS]='20260122 00:00:00.000' WHERE [LUTPTVID]=2981
UPDATE [dbo].[LUT_PricerTypeVariable] SET [DefaultValue]=N'feefq26', [ModifiedTS]='20260122 00:00:00.000' WHERE [LUTPTVID]=3956
UPDATE [dbo].[LUT_PricerTypeVariable] SET [DefaultValue]=N'319.38', [ModifiedTS]='20260122 00:00:00.000' WHERE [LUTPTVID]=4371
UPDATE [dbo].[LUT_PricerTypeVariable] SET [DefaultValue]=N'418.45', [ModifiedTS]='20260122 00:00:00.000' WHERE [LUTPTVID]=4459
