...
SET @FromDVersion = '2604.02'; -- the DVersion in the database
...
BEGIN TRANSACTION
  BEGIN TRY
    ...
    INSERT INTO [dbo].[ADM_SystemVersion] ([AVersion], [DVersion], [PVersion], [InsertedTS])
      VALUES (N'2604.02', N'2605.00', NULL, GETDATE())
...
--US1591186: V2605.00 - New Mexico Medicaid APC Description and Start Date Update
UPDATE [dbo].[LUT_PricerTypeVariable] SET [ModifiedTS]='20260507 00:00:00.000', [DisplayStartDate]='00010101' WHERE [LUTPTVID]=4112
